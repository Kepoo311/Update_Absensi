...
function checkTime() {
    ...
    if ((currentHour >= morningStart && currentHour <= morningEnd) ||
        ...
        const errorMessage =
            `Absen Kehadiran hanya dapat dilakukan pada jam 07:00 - 09:00 pagi. Sekarang jam ${currentHour}:${currentMinute}.`;
...
function success(result) {
    try {
        ...
        document.getElementById('Status_Absen').innerHTML = `
                Absen Hadir Berhasil
            `;
        Swal.fire({
            icon: 'success',
            title: 'Terima Kasih!! 👌',
            text: "Absen Telah Berhasil",
            showConfirmButton: false,
            timer: 2000
        });
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "INSERT INTO `tb_absensi` (`id`, `kelas`, `tanggal`, `nama_guru`, `status_absen`, `keterangan`) VALUES (NULL, NULL, '$currentDate', '$nama', 'Hadir', 'Absensi Hadir');";
